"""
Legacy Pre-Coding Functions (Backward Compatibility)

These functions are kept for backward compatibility with the existing
multiple-choice question flow for explain_code and error_code stages.
"""
...
def get_student_precoding_state(student_id: str, problem_id: str) -> Dict[str, Any]:
    with engine.connect() as conn:
        ...
        raw_explain_qs = question_data["explain_code_question"] or []
